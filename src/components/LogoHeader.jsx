...
const LogoHeader = () => (
  <div style={{ display: 'flex', alignItems: 'center', padding: '18px 0 12px 24px', background: 'var(--header-bg)', position: 'relative', zIndex: 10, borderBottom: '1px solid var(--border-color, #e5e7eb)' }}>
    ...
    <div style={{ display: 'flex', flexDirection: 'column' }}>
      <span style={{ fontFamily: 'Inter, Helvetica Neue, Arial, sans-serif', fontWeight: 900, fontSize: 30, color: 'var(--header-text)', letterSpacing: '-1px', textTransform: 'uppercase' }}>FieldFolio</span>
